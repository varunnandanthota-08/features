...
9. If information is missing, you MUST say: "That information is not available in my CareOS knowledge base."
10. NEVER convert "not mentioned" into "does not exist" or "not supported."
...
fs.writeFileSync('C:/Users/varun/.gemini/antigravity-ide/brain/8cb038a7-1721-42e6-9ece-ef04fd3f33ee/scratch/updated_workflow5.json', JSON.stringify(workflows, null, 2));
console.log("Updated workflow saved to updated_workflow5.json");
